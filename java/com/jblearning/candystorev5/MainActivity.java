...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate( Bundle savedInstanceState ) {
    ...
    setSupportActionBar( toolbar );//set the toolbar defined in activity_main as action bar
 ...
 //called whenever we retrive from other activities
  ...
  public void updateView( ) {
    ...
    if( candies.size( ) >= 0 ) {
      ...
      //two candies(= two buttons) per row
      //line 73, the second para let us do this
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    switch ( id ) {
      ...
      case R.id.action_reset:
        total = 0.0;
        return true;
      case R.id.action_total_revenue:
        String totalRevenue =
                NumberFormat.getCurrencyInstance( ).format( dbManager.totalRevenue() );
        Toast.makeText(MainActivity.this,"The total revenue is:" + totalRevenue,
  ...
  public void checkout( View v ) {
    ...
    dbManager.totals(checkout_total);
    String checkout =
            NumberFormat.getCurrencyInstance( ).format( checkout_total );
    Toast.makeText( MainActivity.this, checkout,
            Toast.LENGTH_LONG ).show( );
    total = 0.0;
  }
}
